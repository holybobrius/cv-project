        ...
        <div className="formContainer">
            ...
            <form>
                ...
                <div className="email-div">
                    ...
                    <br></br>
                    <input id="email" className="info-input" type="email" placeholder="Your E-Mail"></input>
                    <PElement></PElement>
                </div>
                ...
                <div className="phone-number-div">
                    ...
                    <br></br>
                    <input id="phone-number" className="info-input" type="text" placeholder="Your Phone Number"></input>
                    <PElement></PElement>
                </div>
